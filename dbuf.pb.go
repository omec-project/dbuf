...
type GetDbufStateResponse struct {
	MaximumQueues        uint64   `protobuf:"varint,1,opt,name=maximum_queues,json=maximumQueues,proto3" json:"maximum_queues,omitempty"`
	AllocatedQueues      uint64   `protobuf:"varint,2,opt,name=allocated_queues,json=allocatedQueues,proto3" json:"allocated_queues,omitempty"`
	EmptyQueues          uint64   `protobuf:"varint,3,opt,name=empty_queues,json=emptyQueues,proto3" json:"empty_queues,omitempty"`
...
func (m *GetDbufStateResponse) GetMaximumQueues() uint64 {
	if m != nil {
		return m.MaximumQueues
	}
	return 0
}

func (m *GetDbufStateResponse) GetAllocatedQueues() uint64 {
	if m != nil {
		return m.AllocatedQueues
	}
	return 0
}

func (m *GetDbufStateResponse) GetEmptyQueues() uint64 {
	if m != nil {
		return m.EmptyQueues
	}
	return 0
}
...
var fileDescriptor_60b6dc1b0941c986 = []byte{
	...
	,
}
